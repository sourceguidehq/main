...
const JoinUsPage: React.FC = () => {
  ...
  Let your expertise resonate within our community, and together, let's elevate SourceGuide to even greater heights. Your input is not just valued; it's essential in making SourceGuide the go-to platform for open source enthusiasts worldwide.
</p>
        <div className="flex justify-center space-x-4">
          <Link href="https://github.com/sourceguidehq">
            <Button> <Github className="mr-2 h-5 w-5" />Contribute Now</Button>
          </Link>
          {/* Add discored invite link later */}
